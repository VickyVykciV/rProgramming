...
- Convert Attrition which is categorical variable into a numeric factor value
...
Dev_Sample <- attritionData[train_ind, -c(33:44)]
Hold_Out_Sample <- attritionData[-train_ind, -c(33:44)]
