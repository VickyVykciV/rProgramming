...
```
We see, there is not much of gradation in the predicted probabilities of each quantile, so we have to scale the data. Let's build the model after scaling the data.
